...
class TendenciasGrafico:
    ...
    def plot_data(self, frame, data, anio_inicio, anio_fin):
        ...
        if data:
            ...
            plot.plot(años, residentes_españa, 'bo-', label='Residentes en España')
            plot.plot(años, residentes_extranjero, 'go-', label='Residentes en el Extranjero')
            ...
            if anio_inicio != anio_fin:
                ...
                plot.plot(años_proyección, polinomio_españa(años_proyección - int(anio_inicio)), "b--", label='Tendencia España')
                ...
                plot.plot(años_proyección, polinomio_extranjero(años_proyección - int(anio_inicio)), "g--", label='Tendencia Extranjero')
            else:
                print("El año de inicio y fin son el mismo. No se trazan líneas de tendencia.")

            plot.set_title('Tendencia de Residentes')
            plot.set_xlabel('Año')
            plot.set_ylabel('Número de Residentes')
            plot.legend()
